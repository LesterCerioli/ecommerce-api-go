...
type NewsItem struct {
	...
	ShortContent      string             `gorm:"column:short_content;size:450"`
	FullContent       string             `gorm:"column:full_content"`
	...
	Categories        []NewsItemCategory `gorm:"foreignKey:NewsItemID;references:ID"`
}

func (NewsItem) TableName() string {
	return "public.news_items"
}
